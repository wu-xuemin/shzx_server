    ...
    <div class="root_div">
        <el-form :model="filters" label-position="right" label-width="60px">
            <el-row>
                ...
                <el-col :span="4" v-if="currentUserAgent == 0">
        ...
        <el-row>
            <el-table
                ...
                <el-table-column
                        ...
                        label="公司名称">
                    <template scope="scope">
                        {{scope.row.customerCompany == 0 || scope.row.customerCompany == null ? "" : scope.row.customerCompany}}
                    </template>
                </el-table-column>
                <el-table-column
                        align="center"
            ...
            <el-form :model="form">
                ...
                <el-col :span="12">
                    <el-form-item label="地址：" :label-width="formLabelWidth">
                        <el-input v-model="form.address" @change="onChange"></el-input>
                    </el-form-item>
                </el-col>
                <el-col :span="12">
            ...
            onEidt() {
                ...
                if (!_this.isError) {
                    updateUser(this.modifyForm).then(response => {
                        if (responseIsOK(response)) {
                            showMSG(_this, "修改客户信息成功！", 1);
                            _this.modifyDialogVisible = false;
                            this.onSelectUsers();
                        }
                        else {
                            showMessage(_this, isStringEmpty(response.data.message) ? "修改客户信息失败！" : response.data.message);
                        }
                    });
                }
            },
